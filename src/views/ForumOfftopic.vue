          ...
          <div class="p-4 md:p-6">
            <div class="max-w-4xl mx-auto">
              <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
                ...
                <router-link to="/home/newPost" class="inline-flex items-center bg-indigo-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-indigo-700 transition">
                  <!-- Icono: Plus -->
              ...
              <div class="space-y-6">
                ...
                <router-link v-for="post in posts" :key="post._id" :to="`/home/post/${post._id}`" class="block no-underline">
                  <PostItem 
                    :key="post._id" 
                    :title="post.title" 
                    :author="post.author" 
