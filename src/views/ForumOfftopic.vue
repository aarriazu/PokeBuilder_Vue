          ...
          <ion-row>
            ...
            <ion-col size="12" size-md="9" class="pl-0 md:pl-4">
              <div class="bg-white rounded-lg shadow-sm border-2 border-gray-300 p-6">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">Bienvenido al foro de off-topic</h2>
                <p class="text-gray-600 text-sm mb-4">
                  Aquí puedes discutir temas no relacionados con Pokémon. Comparte tus intereses y participa en conversaciones diversas con otros entrenadores.
                </p>
                ...
                <div class="space-y-4">
                  <a href="/home/post" class="block">
                    <img 
                      src="/src/assets/images/forum/forumPostOfftopic.png" 
                      alt="Publicación 1" 
